...
#       -Backup/Recovery Funktion einbauen		 #
#       -Einzel-IP-Bann Funktion		         #
#       -Anti-Spam Modul				 #
#	-Autostart					 #
##########################################################
...
##########################################################
# Changelog:						 #
# 07.09.2010   -Synblock Core    			 #
#              -Ausgabe verbessert			 #
#	       -Logo eingefügt				 #
#	       -Config in externe Datei verlagert        #
#              -Script gekürzt				 #
# 08.09.2010						 #
#	       -Zeichen gefixxt 			 #
#	       -Bugs behoben                             #
#	       -Log-Datei für wichtige Befehle           #
# 09.09.2010                                             #
#              -IP-Counter u. BADLST Bann gefixxt        #
#	       -Monitor Modul gebaut			 #
# 16.09.2010   						 #
#	       -Aktive Syn-Verbindungen anzeige entfernt #
#	       -Monitor aktualisiert sich nun selbst     #
#	       -Anlegen von Regeln verbessert            #
#	       -Befehls-Aliase eingebaut		 #
# 22.09.2010   						 #
#	       -Iptables Script gefixxt			 #
# 	       -Installer angepasst			 #
##########################################################
...
#echo Es wurden $ipcount IP-Adressen blockiert;
done;
}
...
#echo "  .------------------------------------------------."
echo "  .--------|___/-----------------------------------."
echo "  |  »SynBlock Monitor starten                | -m |"
echo "  |  »IPtables Einstellungen vornehmen:       | -i |"
echo "  |  »IPtables Einstellungen verwerfen:       | -f |"
echo "  |  »Alle IP's aus bad.lst blocken:          | -b |"
echo "  |  »syctl.conf Tuning vornehmen:            | -t |"
echo "  |  »Antispoofing aktivieren:                | -a |"
echo "  |  »SynBlock beenden:                       | -q |"
echo "  '------------------------------------------------'"
...
case "$1" in
     ...
     -t | -tuning | t | tuning)
	    ...
	    echo "  Status:"
	    echo "  .---------------------------------------."
            echo "  | Tuning der sysctl.conf abgeschlossen! |"
	    echo "  '---------------------------------------'"
            echo;
	...
	-m | -monitor | -mon | monitor | m)
     ...
     -f | -flush | f | flush | leeren | -leeren)
	    ...
	    start;
            ...
            echo "  Status:"
            echo "  .--------------------------------."
            echo "  | IPtables leeren abgeschlossen! |"
            echo "  '--------------------------------'"
            echo;
            ;;
